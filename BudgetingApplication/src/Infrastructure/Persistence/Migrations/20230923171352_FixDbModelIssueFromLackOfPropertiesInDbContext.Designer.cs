...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230923171352_FixDbModelIssueFromLackOfPropertiesInDbContext")]
    partial class FixDbModelIssueFromLackOfPropertiesInDbContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetUser", b =>
                {
                    b.Property<int>("BudgetsSharedWithThisUserId")
                        .HasColumnType("integer");

                    b.Property<string>("UsersWithSharedAccessId")
                        .HasColumnType("text");

                    b.HasKey("BudgetsSharedWithThisUserId", "UsersWithSharedAccessId");
            ...
            modelBuilder.Entity("Domain.Entities.BudgetEntryCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BudgetUser", b =>
                {
                    b.HasOne("Domain.Entities.Budget", null)
                        .WithMany()
                        .HasForeignKey("BudgetsSharedWithThisUserId")
            ...
            modelBuilder.Entity("Domain.Entities.BudgetEntry", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.BudgetEntryCategory", "Category")
                        .WithMany("BudgetEntries")
